...
/*
 * This version includes additional code after the 2013 ANL copyright.  All
 * of this code, including the original, was written by William Gropp.
 */
...
int main(int argc, char *argv[])
{
    ...
    if (rank == 0) {
        fprintf(stderr, "This program require MPI 3 or later\n");
        fflush(stderr);
    }
